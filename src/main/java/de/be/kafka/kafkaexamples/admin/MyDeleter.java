...
//
//
////requires compile('org.apache.kafka:kafka-clients:2.0.0') //used by classes in de.be.kafka.kafkaexamples.admin package, which is not compatible with current spring-kafka-test
//@Service
